...
READ_ONLY = select.EPOLLIN | select.EPOLLPRI | select.EPOLLERR | select.EPOLLHUP | select.EPOLLET
READ_WRITE = READ_ONLY | select.EPOLLOUT
message_queues = {}
fd_to_socket = {server.fileno(): server}

epoll = select.epoll()
epoll.register(server, select.EPOLLIN | select.EPOLLPRI)
                ...
                while True:
                    try:
                        ...
                        if data:
                            ...
                            print('Closing from', sock.getpeername())
